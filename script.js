...
const rawData = [
    ...
    { id: "5", side: 'right', ...ROLES.nn, zh: "今天几月几号？", th: "วันนี้วันที่เท่าไหร่" },
    { id: "6", side: 'left', ...ROLES.bb, zh: "今天十一月二十九号？", th: "วันนี้วันที่ 29 พฤศจิกายน" },
    { id: "7", side: 'right', ...ROLES.nn, zh: "今天星期几？", th: "วันนี้วันอะไร" },
    { id: "8", side: 'left', ...ROLES.bb, zh: "今天星期二。", th: "วันนี้วันอังคาร" },
    { id: "9", side: 'right', ...ROLES.nn, zh: "现在几点？", th: "ตอนนี้กี่โมง" },
    { id: "10", side: 'left', ...ROLES.bb, zh: "现在七点。", th: "ตอนนี้ 7โมง" },
    { id: "11", side: 'left', ...ROLES.bb, zh: "现在几点？", th: "ตอนนี้กี่โมง" },
    { id: "12", side: 'right', ...ROLES.nn, zh: "现在四点四十五分。", th: "ตอนนี้ 4:45" },
    { id: "13", side: 'left', ...ROLES.bb, zh: "你会游泳吗？", th: "คุณว่ายน้ำเป็นไหม" },
    { id: "14", side: 'right', ...ROLES.nn, zh: "我不会游泳。", th: "ฉันว่ายน้ำไม่เป็น" },
    { id: "15", side: 'left', ...ROLES.bb, zh: "你会打篮球吗？", th: "คุณเล่นบาสเกตบอลเป็นไหม" },
    { id: "16", side: 'left', ...ROLES.bb, zh: "我会打篮球。", th: "ฉันเล่นบาสเกตบอลเป็น" },
    { id: "17", side: 'left', ...ROLES.bb, zh: "你要买什么？", th: "คุณจะซื้ออะไร" },
    { id: "18", side: 'right', ...ROLES.nn, zh: "我要买本子。", th: "ฉันจะซื้อสมุด" },
    { id: "19", side: 'right', ...ROLES.nn, zh: "多少钱？", th: "เท่าไหร่" },
    { id: "20", side: 'left', ...ROLES.bb, zh: "两块。", th: "2 เหรียญ " },
    { id: "21", side: 'left', ...ROLES.mama, zh: "你想吃什么？", th: "คุณอยากกินอะไร" },
    { id: "22", side: 'right', ...ROLES.nn, zh: "我想吃汉堡包", th: "ฉันอยากกินแฮมเบอร์เกอร์" },
    { id: "23", side: 'left', ...ROLES.mama, zh: "你想喝什么？", th: "คุณอยากดื่มอะไร" },
    { id: "24", side: 'left', ...ROLES.bb, zh: "我想喝牛奶。", th: "ฉันอยากดื่มนม" },
    { id: "25", side: 'left', ...ROLES.bb, zh: "你在干什么？", th: "คุณกำลังทำอะไร" },
    { id: "26", side: 'right', ...ROLES.nn, zh: "我在学习，", th: "ฉันกำลังเรียน" },
    { id: "27", side: 'left', ...ROLES.bb, zh: "你在学习什么？", th: "คุณกำลังเรียนอะไร" },
    { id: "28", side: 'right', ...ROLES.nn, zh: "我在学习汉语。", th: "ฉันกำลังเรียนภาษาจีน" },
    { id: "29", side: 'left', ...ROLES.bb, zh: "我比你高。", th: "ฉันสูงกว่าคุณ" },
    { id: "30", side: 'right', ...ROLES.nn, zh: "我比你矮。", th: "ฉันเตี้ยกว่าคุณ" },
    { id: "31", side: 'left', ...ROLES.bb, zh: "我比你大。", th: "ฉันโตกว่าคุณ" },
    { id: "32", side: 'right', ...ROLES.nn, zh: "我比你小。", th: "ฉันเด็กกว่าคุณ" },
    ...
    { id: "37", side: 'left', ...ROLES.bb, zh: "今天天气怎么样？", th: "วันนี้อากาศเป็นอย่างไร" },
    { id: "38", side: 'right', ...ROLES.nn, zh: "今天天气很好，", th: "วันนี้อากาศดี" },
    { id: "38-2", side: 'right', ...ROLES.nn, zh: "今天晴天。", th: "วันนี้แดดออก" },
    { id: "39", side: 'left', ...ROLES.bb, zh: "今天天气怎么样？", th: "วันนี้อากาศเป็นอย่างไร" },
    { id: "40", side: 'right', ...ROLES.nn, zh: "今天天气不好，", th: "วันนี้อากาศไม่ดี" },
    { id: "40-2", side: 'right', ...ROLES.nn, zh: "今天下雨。", th: "วันนี้ฝนตก" }
];
